function Footer(){
    return <div style={{
        ...
        <div style={{
            ...
            <img src="public\images\thexplace-logo.png" alt="Footer-logo" />
            <span style={{
        ...
        <div style={{
            ...
            <div>
                <Logo src="public\twitter.png"/>
                <Logo src="public\linkedin.png"/>
                <Logo src="public\facebook.png"/>
                <Logo src="public\Discord.png"/>
            </div>
        </div>
    </div>
}
